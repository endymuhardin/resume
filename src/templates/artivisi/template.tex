...
\newcommand{\cvlocation}[1]{%
    \begin{center}
        {\small\color{medgray} \faIcon{map-marker-alt} #1}
    \end{center}
    \vspace{0.4em}
}
...
% Header
\cvheader{$personal.firstname$ $personal.familyname$}{$personal.title$}{$personal.email$}{$personal.phone$}{$personal.homepage$}
\cvlocation{$personal.address.city$, $personal.address.region$}
