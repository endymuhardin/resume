...
\titleformat{\section}
    {\vspace{0.3em}\large\bfseries\color{primary}}
    {}
    {0pt}
    {}
    [\vspace{0.1em}{\color{accent}\hrule height 1.5pt}\vspace{0.2em}]
...
\newcommand{\cvconsult}[3]{%
    {\small\textbf{#1} {\color{medgray}-- #2} \hfill {\color{lightgray}#3}}\\[0.15em]
}

\newcommand{\cvedu}[4]{%
    \textbf{#1} \hfill {\small\color{lightgray}#3}\\[-0.2em]
    {\small\textit{#2} \hfill \color{lightgray}#4}\\[0.2em]
}
...
% Consulting - Compact two-column list
